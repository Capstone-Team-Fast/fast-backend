...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_id("formGridDurationLimit").send_keys("2")
        ...
        driver.find_element_by_xpath("//div[2]/form/div/div/input").click()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Diannne Scurfield (Quantity: 10)'])[1]/following::li[1]").click()
